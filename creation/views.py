...
class PostListView(LoginRequiredMixin, ListView):
    model = Post
    template_name = 'creation/blog.html'
...
class PostDetailView(LoginRequiredMixin,DetailView):
    model=Post
    template_name='creation/post_detail.html'
...
class PostCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        return reverse('creation:blog-detail', kwargs={'pk': self.object.pk})
...
class PostUpdateView(LoginRequiredMixin,UserPassesTestMixin,UpdateView):
    ...
    def get_success_url(self):
        return reverse('creation:blog-new')
...
class PostDeleteView(LoginRequiredMixin,DeleteView):
    model=Post
    template_name = 'creation/post_confirm_delete.html'
...
class LikePostView(LoginRequiredMixin,View):
    def get(self, request, *args, **kwargs):
        ...
        return HttpResponseRedirect(reverse('creation:blog-detail', args=[str(post.id)]))
...
class CommentCreateView(LoginRequiredMixin,View):
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid(): 
            ...
            comment.save()
        return redirect('creation:blog-detail', pk=post.id)

class CommentUpdateView(LoginRequiredMixin,View):
    template_name = 'creation/comment_edit.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            form.save()
            return redirect('creation:blog-detail', pk=comment.post.id)
        else:
            print(form.errors)
...
class CommentDeleteView(LoginRequiredMixin,View):
    def get(self, request, *args, **kwargs):
        ...
        comment.delete()
        return redirect('creation:blog-detail', pk=post_id)