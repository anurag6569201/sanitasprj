...
class Sanitizer(models.Model):
    CITY_CHOICES = (
    ('Nandamuri Taraka Rama Rao (NTR)','Nandamuri Taraka Rama Rao (NTR)'),
    ('Charaideo','Charaideo'),
    ('Darrang','Darrang'),
    ('Jehanabad','Jehanabad'),
    ('Ahmedabad','Ahmedabad'),
    ...
    ('Y.S.R. (Yeduguri Sandinti Rajasekhara Reddy)','Y.S.R. (Yeduguri Sandinti Rajasekhara Reddy)'),
    ('South Goa','South Goa'),
    ('Rupnagar','Rupnagar'),
    ('Jaunpur','Jaunpur'),
    ('Kasganj','Kasganj'),
...
class TrendingData(models.Model):
    ...
    def save(self, *args, **kwargs):
        if not self.created_at:  # Only set if it's not already provided
